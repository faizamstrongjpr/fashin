import{w as o,x as n,y as r,f as d}from"./index-DwLuqkeG.js";async function g(s){const e=o();s.innerHTML=`
            ...
            <div class="settings-card">
                <div class="radio-group">
                    <label class="radio-label">
                        <input type="radio" name="quality" value="standard" ${e==="standard"?"checked":""}>
                    ...
                    <label class="radio-label">
                        <input type="radio" name="quality" value="high" ${e==="high"?"checked":""}>
                        <div class="radio-content">
                    ...
                    <label class="radio-label">
                        <input type="radio" name="quality" value="lossless" ${e==="lossless"?"checked":""}>
                        <div class="radio-content">
    ...
    `,s.querySelectorAll('input[name="quality"]').forEach(l=>{l.addEventListener("change",i=>{n(i.target.value),r(),d(`Kualitas diubah ke ${i.target.parentElement.querySelector(".radio-title").textContent}`)})});const t=document.getElementById("settings-theme-toggle"),a=document.getElementById("theme-toggle-checkbox");t&&a&&(t.checked=a.checked,t.addEventListener("change",()=>{a.click()}))}export{g as render};
